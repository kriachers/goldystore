...
function ThumbItem (props) {
    ...
    const {setClickedItem} = React.useContext(AppContext)

    return (
        <Link to='/item' onClick={(event) => setClickedItem(props.item)}>
            <div className="sale-plate__tile">
                    
                    <Link to={''}>
                    <svg 
                    onClick={() => props.openEye(props.item)} 
                    
                    className="sale-icon__eye svg-icon" width="24" height="24" viewBox="0 0 24 24" fill="#C9C9C9" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="sale-tile__stickers"> 
                            ...
                            <div className="sale-stickers__icons">
                                <Link to={''}><Like item={props.item}></Like></Link>
                            </div>
                        </div>
